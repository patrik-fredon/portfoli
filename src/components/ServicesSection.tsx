...
const services = [
  {
    ...
    description: 'Develop comprehensive business strategies to drive growth and competitive advantage.',
    icon: (
  ...
  },
  {
    ...
    description: 'Guide organizations through digital transformation initiatives to enhance operations.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
  ...
  },
  {
    ...
    description: 'Lead complex projects with proven methodologies for successful delivery.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            ...
            through proven methodologies and expertise.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg hover:shadow-xl 
